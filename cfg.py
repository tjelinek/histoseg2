...
class Config:
    ...
    dtype_to_format: Dict[str, str] = field(default_factory=lambda: {
        'uint8': 'uchar',
        'int8': 'char',
        'uint16': 'ushort',
        'int16': 'short',
    ...
    mapping_classes_feit: Dict[str, str] = field(default_factory=lambda: {
    ...
    selected_classes_feit: Set[str] = field(default_factory=lambda: {
